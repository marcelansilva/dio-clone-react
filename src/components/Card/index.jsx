...
const Card = () => {
  return (
    <CardContainer>
      ...
      <Content>
        <UserInfo>
          <UserPicture src="https://avatars.githubusercontent.com/u/85529043?v=4" />
          <div>
            <h4>Marcela Silva</h4>
            <p>Há 9 minutos</p>
          </div>
        ...
        <PostInfo>
          ...
          <p>
            Projeto feito no curso de ReactJS no bootcamp OrangeTech+ da DIO em
            parceria com o Inter...<strong>Saiba Mais</strong>
          </p>
        </PostInfo>
        <HasInfo>
